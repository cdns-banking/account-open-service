...
/**
 * StudentAccountOpenStrategy
 * 
 * @version 1.0
 */
public class StudentAccountOpenStrategy implements AccountOpenStrategy {
	...
	public String sendOpenAccountRequest(AccountRequest request) throws RestClientException, URISyntaxException {
		...
		return restTemplate.postForObject(new URI(env.getProperty("university.validate.url")), httpRequest,
				String.class);
	}
	...
	public AccountOpenStrategyNames getStrategy() {
		return AccountOpenStrategyNames.STUDENT_ACCOUNT_CREATION_STRATEGY;
	}
